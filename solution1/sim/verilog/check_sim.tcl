...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.bgsub.autotvin_gmem.dat"
         "c.bgsub.autotvin_gmem_offset.dat"
         "c.bgsub.autotvin_frame_in.dat"
         "c.bgsub.autotvin_frame_out.dat"
         "c.bgsub.autotvin_init.dat"
         "c.bgsub.autotvin_bgmodel.dat"
         "c.bgsub.autotvout_gmem.dat"
         "c.bgsub.autotvout_gmem_offset.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.bgsub.autotvout_gmem.dat"
         "rtl.bgsub.autotvout_gmem_offset.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
