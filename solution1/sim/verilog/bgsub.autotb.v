...
`define AUTOTB_DUT      bgsub
`define AUTOTB_DUT_INST AESL_inst_bgsub
`define AUTOTB_TOP      apatb_bgsub_top
`define AUTOTB_LAT_RESULT_FILE "bgsub.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "bgsub.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_bgsub_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_TRANSACTION_NUM  8
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00
`define LENGTH_gmem 153600
`define LENGTH_gmem_offset 614400
`define LENGTH_frame_in 1
`define LENGTH_frame_out 1
`define LENGTH_init 1
`define LENGTH_bgmodel 1
...
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.bgsub.autotvin_gmem.dat"
`define AUTOTB_TVIN_gmem_offset_out_wrapc  "../tv/rtldatafile/rtl.bgsub.autotvin_gmem_offset.dat"
`define AUTOTB_TVIN_frame_in_out_wrapc  "../tv/rtldatafile/rtl.bgsub.autotvin_frame_in.dat"
`define AUTOTB_TVIN_frame_out_out_wrapc  "../tv/rtldatafile/rtl.bgsub.autotvin_frame_out.dat"
`define AUTOTB_TVIN_init_out_wrapc  "../tv/rtldatafile/rtl.bgsub.autotvin_init.dat"
`define AUTOTB_TVIN_bgmodel_out_wrapc  "../tv/rtldatafile/rtl.bgsub.autotvin_bgmodel.dat"
...
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.bgsub.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_offset_out_wrapc  "../tv/rtldatafile/rtl.bgsub.autotvout_gmem_offset.dat"
...
AESL_axi_master_gmem_offset AESL_AXI_MASTER_gmem_offset(
    ...
    .TRAN_gmem_offset_bgmodel (bgmodel),
