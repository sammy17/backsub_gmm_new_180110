...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "bgsub.autotvin.dat"
	set constFileTvOut       "bgsub.autotvout.dat"
	set constFileHdlTvIn     "bgsub.autohdltvin.dat"
	set constFileHdlTvOut    "bgsub.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
