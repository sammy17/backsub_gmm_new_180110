...
#ifndef __backsub_faddfsub_32ns_32ns_32_5_full_dsp__HH__
#define __backsub_faddfsub_32ns_32ns_32_5_full_dsp__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(backsub_faddfsub_32ns_32ns_32_5_full_dsp) {
    ...
    SC_CTOR(backsub_faddfsub_32ns_32ns_32_5_full_dsp):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
