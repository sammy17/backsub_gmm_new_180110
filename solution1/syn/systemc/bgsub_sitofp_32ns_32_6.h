...
#ifndef __bgsub_sitofp_32ns_32_6__HH__
#define __bgsub_sitofp_32ns_32_6__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(bgsub_sitofp_32ns_32_6) {
    ...
    SC_CTOR(bgsub_sitofp_32ns_32_6):  ACMP_sitofp_U ("ACMP_sitofp_U") {
