...
#ifndef __backsub_urem_34ns_11ns_34_38_seq__HH__
#define __backsub_urem_34ns_11ns_34_38_seq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(backsub_urem_34ns_11ns_34_38_seq) {
    ...
    ACMP_urem_seq<ID, 38, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_urem_seq_U;

    SC_CTOR(backsub_urem_34ns_11ns_34_38_seq):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
