...
struct bgsub : public sc_module {
    ...
    sc_signal< sc_lv<32> > bgmodel_sortKey;
    sc_signal< sc_lv<32> > bgmodel_weight;
    sc_signal< sc_lv<32> > bgmodel_mean;
    sc_signal< sc_lv<32> > bgmodel_var;
    ...
    sc_signal< sc_logic > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_AWVALID;
    sc_signal< sc_logic > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_AWREADY;
    sc_signal< sc_lv<32> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_AWADDR;
    sc_signal< sc_lv<1> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_AWID;
    sc_signal< sc_lv<32> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_AWLEN;
    sc_signal< sc_lv<3> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_AWSIZE;
    sc_signal< sc_lv<2> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_AWBURST;
    sc_signal< sc_lv<2> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_AWLOCK;
    sc_signal< sc_lv<4> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_AWCACHE;
    sc_signal< sc_lv<3> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_AWPROT;
    sc_signal< sc_lv<4> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_AWQOS;
    sc_signal< sc_lv<4> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_AWREGION;
    sc_signal< sc_lv<1> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_AWUSER;
    sc_signal< sc_logic > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_WVALID;
    sc_signal< sc_logic > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_WREADY;
    sc_signal< sc_lv<32> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_WDATA;
    sc_signal< sc_lv<4> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_WSTRB;
    sc_signal< sc_logic > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_WLAST;
    sc_signal< sc_lv<1> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_WID;
    sc_signal< sc_lv<1> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_WUSER;
    sc_signal< sc_logic > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_ARVALID;
    sc_signal< sc_logic > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_ARREADY;
    sc_signal< sc_lv<32> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_ARADDR;
    sc_signal< sc_lv<1> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_ARID;
    sc_signal< sc_lv<32> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_ARLEN;
    sc_signal< sc_lv<3> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_ARSIZE;
    sc_signal< sc_lv<2> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_ARBURST;
    sc_signal< sc_lv<2> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_ARLOCK;
    sc_signal< sc_lv<4> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_ARCACHE;
    sc_signal< sc_lv<3> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_ARPROT;
    sc_signal< sc_lv<4> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_ARQOS;
    sc_signal< sc_lv<4> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_ARREGION;
    sc_signal< sc_lv<1> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_ARUSER;
    sc_signal< sc_logic > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_RVALID;
    sc_signal< sc_logic > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_RREADY;
    sc_signal< sc_lv<32> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_RDATA;
    sc_signal< sc_logic > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_RLAST;
    sc_signal< sc_lv<1> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_RID;
    sc_signal< sc_lv<1> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_RUSER;
    sc_signal< sc_lv<2> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_RRESP;
    sc_signal< sc_logic > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_BVALID;
    sc_signal< sc_logic > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_BREADY;
    sc_signal< sc_lv<2> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_BRESP;
    sc_signal< sc_lv<1> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_BID;
    sc_signal< sc_lv<1> > bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_BUSER;
    sc_signal< sc_lv<32> > bgsub_Block_proc_U0_bgmodel_sortKey1;
    sc_signal< sc_lv<32> > bgsub_Block_proc_U0_bgmodel_weight;
    sc_signal< sc_lv<32> > bgsub_Block_proc_U0_bgmodel_mean;
    sc_signal< sc_lv<32> > bgsub_Block_proc_U0_bgmodel_var;
    ...
    void thread_bgsub_Block_proc_U0_bgmodel_mean();
    void thread_bgsub_Block_proc_U0_bgmodel_sortKey1();
    void thread_bgsub_Block_proc_U0_bgmodel_var();
    void thread_bgsub_Block_proc_U0_bgmodel_weight();
    void thread_bgsub_Block_proc_U0_frame_in();
    void thread_bgsub_Block_proc_U0_frame_out2();
    void thread_bgsub_Block_proc_U0_init();
    void thread_bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_ARREADY();
    void thread_bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_AWREADY();
    void thread_bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_BID();
    void thread_bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_BRESP();
    void thread_bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_BUSER();
    void thread_bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_BVALID();
    void thread_bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_RDATA();
    void thread_bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_RID();
    void thread_bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_RLAST();
    void thread_bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_RRESP();
    void thread_bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_RUSER();
    void thread_bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_RVALID();
    void thread_bgsub_Block_proc_U0_m_axi_bgmodel_sortKey_WREADY();
