...
#ifndef __backsub_urem_33ns_12ns_33_37_seq__HH__
#define __backsub_urem_33ns_12ns_33_37_seq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(backsub_urem_33ns_12ns_33_37_seq) {
    ...
    ACMP_urem_seq<ID, 37, din0_WIDTH, din1_WIDTH, dout_WIDTH> ACMP_urem_seq_U;

    SC_CTOR(backsub_urem_33ns_12ns_33_37_seq):  ACMP_urem_seq_U ("ACMP_urem_seq_U") {
