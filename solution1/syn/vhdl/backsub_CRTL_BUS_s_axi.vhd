...
entity backsub_CRTL_BUS_s_axi is
generic (
...
end entity backsub_CRTL_BUS_s_axi;
...
architecture behave of backsub_CRTL_BUS_s_axi is
    type states is (wridle, wrdata, wrresp, rdidle, rddata);  -- read and write fsm states
    signal wstate, wnext, rstate, rnext: states;
    constant ADDR_LEARNINGRATE_DATA_0 : INTEGER := 16#10#;
    constant ADDR_LEARNINGRATE_CTRL   : INTEGER := 16#14#;
    ...
    -- internal registers
    signal int_learningRate    : UNSIGNED(31 downto 0);
