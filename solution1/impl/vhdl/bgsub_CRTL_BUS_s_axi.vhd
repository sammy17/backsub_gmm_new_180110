...
entity bgsub_CRTL_BUS_s_axi is
generic (
...
end entity bgsub_CRTL_BUS_s_axi;
...
architecture behave of bgsub_CRTL_BUS_s_axi is
    ...
    constant ADDR_INIT_DATA_0 : INTEGER := 16#10#;
    constant ADDR_INIT_CTRL   : INTEGER := 16#14#;
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_INIT_DATA_0) then
                    int_init(0 downto 0) <= (UNSIGNED(WDATA(0 downto 0)) and wmask(0 downto 0)) or ((not wmask(0 downto 0)) and int_init(0 downto 0));
                end if;
            end if;
        end if;
    end process;
