...
set IPName      "bgsub"
set Version     "1.0"
set DisplayName "Bgsub"
set Revision    "1801131659"
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 frame_in W 0x0 "Data signal of frame_in" {{0 32 frame_in W 0 "Bit 31 to 0 Data signal of frame_in"}}} {0x18 frame_out W 0x0 "Data signal of frame_out" {{0 32 frame_out W 0 "Bit 31 to 0 Data signal of frame_out"}}} {0x20 bgmodel W 0x0 "Data signal of bgmodel" {{0 32 bgmodel W 0 "Bit 31 to 0 Data signal of bgmodel"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS s_axi_CRTL_BUS m_axi_gmem m_axi_gmem_offset"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_gmem {
        ...
        NUM_READ_OUTSTANDING "6"
        NUM_WRITE_OUTSTANDING "6"
    }
    m_axi_gmem_offset {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_gmem_offset"
        data_width "32"
        param_prefix "C_M_AXI_GMEM_OFFSET"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 1905122 II x}
...
set enable_xo_gen 0
set kernel_files {/home/chathura/Desktop/maxi_final_180113/backsub_gmm_new_180110/core.cpp}
if {$enable_xo_gen} {
