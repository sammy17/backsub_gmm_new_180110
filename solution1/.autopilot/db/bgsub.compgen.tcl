...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler bgsub_gmem_m_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    max_latency -1 \ 
    delay_budget 8.75 \ 
    name {bgsub_gmem_offset_m_axi} \
} "
} else {
puts "@W \[IMPL-110\] Cannot find AXI interface model in the library. Ignored generation of AXI interface for 'gmem_offset'"
}
}
