...
set C_modelArgList { 
	{ frame_in int 8 regular {array 640 { 1 3 } 1 1 }  }
	{ frame_out int 1 regular {array 640 { 0 3 } 0 1 }  }
	{ bgmodel float 32 regular {array 5120 { 2 2 } 1 1 }  }
...
set portList { 
	...
	{ bgmodel_address1 sc_out sc_lv 13 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "frame_in_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "frame_in", "role": "address0" }} , 
 	...
 	{ "name": "frame_out_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "frame_out", "role": "address0" }} , 
 	...
 	{ "name": "bgmodel_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "bgmodel", "role": "address0" }} , 
 	...
 	{ "name": "bgmodel_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "bgmodel", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	frame_in { ap_memory {  { frame_in_address0 mem_address 1 10 }  { frame_in_ce0 mem_ce 1 1 }  { frame_in_q0 mem_dout 0 8 } } }
	frame_out { ap_memory {  { frame_out_address0 mem_address 1 10 }  { frame_out_ce0 mem_ce 1 1 }  { frame_out_we0 mem_we 1 1 }  { frame_out_d0 mem_din 1 1 } } }
	bgmodel { ap_memory {  { bgmodel_address0 mem_address 1 13 }  { bgmodel_ce0 mem_ce 1 1 }  { bgmodel_we0 mem_we 1 1 }  { bgmodel_d0 mem_din 1 32 }  { bgmodel_q0 mem_dout 0 32 }  { bgmodel_address1 mem_address 1 13 }  { bgmodel_ce1 mem_ce 1 1 }  { bgmodel_we1 mem_we 1 1 }  { bgmodel_d1 mem_din 1 32 }  { bgmodel_q1 mem_dout 0 32 } } }
